  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <h2 style="text-align: center">Bem-vindo à sua Agenda, <strong><?php echo $user; ?></strong>.</h2>
        <br>
        <script>
        ...
        <div class="p-2">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="gerir_utili.php?user=<?php echo urlencode($user); ?>&id_user=<?php echo urlencode($id_user); ?>">Gerir Conta
